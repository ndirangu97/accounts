        ...
        <div class="container-fluid page-body-wrapper">
          ...
          flex-basis: 50%;height: 100%;">
                        ...
                        <div style="display:flex;">
                            <p>Name</p>
                            <input style="margin-bottom: 10px;padding-left:20px;border-radius:6px;margin-left: 20px;" class="input" type="text" placeholder="Name" name="name" value="<?php echo ($resultSql->name); ?>" id="" required min="3">
                        </div>


                        <div style="display: flex;">
                            <p>UPI</p>
                            <input style="margin-bottom: 10px;padding-left:20px;border-radius:6px;margin-left: 40px" class="input" type="text" placeholder="UPI no" name="upi" id="" required value="<?php echo ($resultSql->upi); ?>" min="3">
                        </div>
                        ...
                        <div style="display: flex;margin-bottom:20px">
                            <div>
                                ...
                                <!-- <input type="text" id="class" value="<?php echo ($resultSql->class) ?>" style="width: 80px;border: 1px solid #7c7cff ;border-radius: 4px;"> -->
                            </div>
                            <div style="margin-left: 20px;">
                                ...
                                <!-- <input type="text" id="stream" value="<?php echo ($resultSql->stream) ?>" style="width: 80px;border: 1px solid #7c7cff ;border-radius: 4px;"> -->
                            </div>
          ...
          " id="submit" value="Save Pupil" onclick=" collectData(event)">
                ...
                <div style="position:absolute;right:30px;top:40px">
                    <img onclick="bring()" style="cursor: pointer;" src="./images/menu.png" width="20px" height="20px" alt="">
                </div>
                <div id="delm" style="position:absolute;right:60px;top:40px;border:1px solid black;height:40px;width:120px;display: none;justify-content: center;align-items: center;">
                    <p class="ell" onclick="delppl()" style="cursor: pointer;width:100%;text-align:center">Delete pupil</p>
                </div>
            </div>
            <div style="display: none;height: 400px;position:relative;flex-direction:column;overflow:auto;width:100%;" id="stmtHolder">

                <input style="display: none;" type="text" name="" value="<?php echo ($id); ?>" id="inputid">
            </div>
...
<script>
    ...
    const collectData = (e) => {
        ...
        data.class = document.getElementById('class2').value;
        data.stream = document.getElementById('stream2').value;
        data.id = ownid
    ...
    function bring() {
        let dm = document.getElementById('delm')
    ...
    function delppl() {
        let cnf = confirm('Are You Sure you want to delete student?')
