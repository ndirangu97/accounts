          ...
          <div style="display: flex;flex-basis:100%;overflow-y:scroll">
            ...
            <div style="flex-basis: 32%">
              <div style="display: flex;flex-direction:column;width: 100%;height:440px;border:1px solid #009879;border-radius:8px;margin-left:20px">
                ...
                <div id="pdv" style="display: flex;flex-basis:90%;flex-direction:column;align-items:center;margin-top:10px;">
                ...
                <div id="bdv" style="display: none;flex-basis:90%;flex-direction:column;align-items:center;margin-top:10px;">
  ...
  const handleResult = (results) => {
    ...
    switch (info.type) {
      ...
      case 'err':
        ...
        break;
      case 'stmt':
        let stt = document.getElementById('stmtHolder')
