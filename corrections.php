        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="bodyWrapper">
                <div style="height: 40px;width:100%;display: flex;justify-content:center;align-items:center;">
                    ...
                    <div id="changed" style="display: flex;justify-content:center;align-items:center;margin-left:20px">
...
<script>
    ...
    const handleResult = (results) => {
        ...
        switch (info.type) {
            case 'roll':
                ...
                break;
            case 'pupilsaved':
                let b = document.getElementById('changed');
                b.innerHTML = info.message;
    ...
    function changename(e) {
        ...
        let nm = document.getElementsByClassName(e.target.id)[0]
